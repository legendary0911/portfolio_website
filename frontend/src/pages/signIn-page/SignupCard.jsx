...
const SignupCard = (props) => {
    ...
    const { username, email, job, password } = data;
    ...
    const onSubmitHandler = async (e) => {
      ...
      let response;
      try {
        response = await axios.post('http://localhost:9000/signup', 
          {
        ...
        <div>
          ...
          <div class="flex flex-col items-center">
            ...
            <input
              ...
              onChange={onChangeHandler}
              value={password}
              class="border border-gray-600 border-[1px] rounded-md text-center py-2 px-8 mb-4 shadow-md"
              placeholder="Password"
            />
            {user?<VisibilityIcon className='mt-[10px] relative left-[104px] bottom-[57px] text-blue-500' onClick={handleClick}/>:<VisibilityOffIcon className='mt-[10px] relative left-[104px] bottom-[57px]' onClick={handleClick}/>}
