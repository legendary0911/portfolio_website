...
function Fields() {
    ...
    return (
        <div id="skill" className="h-fit pt-2 lg:pt-28  text-black bg-slate-100 dark:bg-yellow-500 lg:flex">
            ...
            <div className="right mx-auto w-fit pb-20 mt-20">
                ...
                <div className="flex space-x-16  lg:space-x-28  text-6xl  md:text-7xl" data-aos="fade-right"   ><SiCplusplus className="hover:scale-[1.35] hover:ease-out duration-[300ms] hover:text-black/[0.6] " /><SiJava className="hover:scale-[1.35] hover:ease-out duration-[300ms] hover:text-black/[0.6] " /><SiPython className="hover:scale-[1.35] hover:ease-out duration-[300ms] hover:text-black/[0.6] " /></div>
