        ...
        <div id="contact">
            <section class=" bg-fixed bg-[url('https://www.collab2.co.za/wp-content/uploads/2017/06/contact-us-background.jpg')] dark:bg-gray-900">
                <div class="  py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <div className="">
                        <h2 class="mb-10 mt-10 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h2>
                        <p class=" mb-64 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
                    </div>
                </div>
            </section>
            <div>
