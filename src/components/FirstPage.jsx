    ...
    <div id="about" className=" pt-0 md:pt-6 md:h[46rem] bg-yellow-500 dark:text-slate-300 dark:bg-[#111827]">
      <div className="lg:flex  ">
        <div className="left flex-col pl-[6%] w-[60%] ">
          ...
          <div id="button">
          <button className=" scale-75 md:scale-100 md:hover:scale-105  hover:scale-90 rounded-2xl  shadow-2xl bg-purple-500 hover:bg-purple-600 cursor-pointer text-white px-8 py-5 mt-10 ease-in-out duration-200">Let's Talk  <SendIcon className=" -rotate-[20deg] ml-2 mb-2" /></button>
        ...
        <div className="right mx-auto  ">
          <img className='mt-10 lg:mt-10 pb-10 pr-10 duration-300 scale-110 mx-auto h-[80%] md:h-[90%] lg:h-[100%]' src="frontend\src\assets\cool.svg"></img>
        </div>
